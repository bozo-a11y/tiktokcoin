@echo off
chcp 65001 >nul
title TTCoinPP - Geliştirme Modu
color 0B

echo ========================================
echo   TTCoinPP - Geliştirme Modu
echo ========================================
echo.
...
echo [2/2] Geliştirme sunucusu başlatılıyor (nodemon)...
echo.
echo ----------------------------------------
...
echo ----------------------------------------
echo.
echo Dosya değişiklikleri otomatik olarak algılanacak.
